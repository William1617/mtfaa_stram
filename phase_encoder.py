...
class PhaseEncoder(nn.Module):
    def __init__(self, cout, n_sig, cin=2, alpha=0.5):
        ...
        for _ in range(n_sig):
            ...
            self.complexnn.append(ComplexConv2d(cin, cout, (1, 3)))
    ...
    def forward(self, cspecs):
        ...
        """
        outs = []
        self.pad=nn.ConstantPad2d((2, 0, 0, 0), 0.0)
        for idx, layer in enumerate(self.complexnn):
            out=self.pad(cspecs[idx])
...
if __name__ == "__main__":
    ...
    outs=nn.ConstantPad2d((2, 0, 0, 0), 0.0)(inps)
    outs=ComplexConv2d(2, 4, (1, 3))(outs)
